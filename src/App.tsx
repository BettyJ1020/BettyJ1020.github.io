        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button onClick={() => scrollToSection('experience')} className="text-stone-100 hover:text-stone-300 transition-colors">Experience</button>
      ...
      <header id="top" className="bg-gradient-to-r from-stone-800 to-stone-900 text-stone-100 pt-16">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-10 text-stone-300">Software Engineer & Data Scientist</p>
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <a href="https://medium.com/@a0976165649" className="hover:text-stone-400 transition-colors flex items-center gap-2">
            ...
            <div className="space-y-8">
              <div className="border-l-2 border-stone-200 pl-6 py-1">
                ...
                <ul className="mt-3 space-y-2 text-stone-600">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="block w-1 h-1 mt-2 rounded-full bg-stone-400"></span>
                    <span>Key Courses: Data Mining, Data Visualization, Operating System, Deep Learning</span>
                  </li>
                </ul>
              </div>
              <div className="border-l-2 border-stone-200 pl-6 py-1">
            ...
            <div className="space-y-8">
              <div className="border-l-2 border-stone-200 pl-6 py-1">
                ...
                <div className="mt-4 relative">
                  <div className="overflow-x-auto pb-4 hide-scrollbar">
                    <div className="flex gap-4" style={{ width: 'max-content' }}>
                      <div className="w-[300px] overflow-hidden rounded-lg shadow-md aspect-video flex-shrink-0">
                        <img 
                          src="https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?auto=format&fit=crop&q=80&w=800&h=450" 
                      ...
                      <div className="w-[300px] overflow-hidden rounded-lg shadow-md aspect-video flex-shrink-0">
                        <img 
                          src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=800&h=450" 
                          alt="Workout Progress Analytics" 
                          className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                          loading="lazy"
                        />
                      </div>
                      <div className="w-[300px] overflow-hidden rounded-lg shadow-md aspect-video flex-shrink-0">
                        <img 
                          src="https://images.unsplash.com/photo-1594882645126-14020914d58d?auto=format&fit=crop&q=80&w=800&h=450" 
                      ...
                      <div className="w-[300px] overflow-hidden rounded-lg shadow-md aspect-video flex-shrink-0">
                        <img 
                          src="https://images.unsplash.com/photo-1507398941214-572c25f4b1dc?auto=format&fit=crop&q=80&w=800&h=450" 
                          alt="Mobile App View" 
                          className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                          loading="lazy"
                        />
                ...
                <ul className="mt-3 space-y-2 text-stone-600">
                  <li className="flex items-start gap-2">
                    <span className="block w-1 h-1 mt-2 rounded-full bg-stone-400"></span>
                    <span>Tech Stack: React, FastAPI, SQLite, PostgreSQL, AWS Amplify</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="block w-1 h-1 mt-2 rounded-full bg-stone-400"></span>
                    <span>Features: User authentication, isolated data management, secure CRUD operations</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="block w-1 h-1 mt-2 rounded-full bg-stone-400"></span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="block w-1 h-1 mt-2 rounded-full bg-stone-400"></span>
                    <span>Real-time progress tracking and analytics dashboard</span>
                  </li>
                </ul>
              </div>
              <div className="border-l-2 border-stone-200 pl-6 py-1">
